...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>
            ...
            (function() {
                const appearance = localStorage.getItem('flux-appearance') || 'dark';
                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button
                            ...
                            @click="toggle()"
                            class="flex h-10 w-10 items-center justify-center rounded-lg text-slate-600 dark:text-slate-300 transition-colors hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-blue-600 dark:hover:text-blue-400"
                            :title="isDark ? 'Switch to light mode' : 'Switch to dark mode'"
                        >
                            <svg x-show="isDark" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
