        ...
        <div class="space-y-4">
            @foreach ($program->weeks->sortBy('week_number') as $week)
                <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
                    <button 
                        type="button" 
                        wire:click="toggleWeek({{ $week->week_number }})"
                    ...
                    >
                        ...
                        <svg 
                            class="w-5 h-5 text-zinc-500 dark:text-zinc-400 transition-transform {{ ($expandedWeeks[$week->week_number] ?? true) ? 'rotate-180' : '' }}"
                            fill="none" 
                            stroke="currentColor" 
                            viewBox="0 0 24 24"
                        >
                                        ...
                                        @else
                                            <div class="space-y-3">
                                                @foreach ($day->exercises as $exercise)
                                                    <div class="rounded border border-neutral-200 dark:border-neutral-600 p-4 bg-white dark:bg-neutral-900">
                                                        <div class="mb-3">
